        ...
        <div style={{ 
              ...
              {isConnected && myScore !== null && (
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      {myDisplayName && (
                        <div style={{ fontSize: '12px', fontWeight: '600', color: '#fff', marginBottom: '2px', lineHeight: '1.4' }}>
                          {myDisplayName}
                        </div>
                      )}
                      {myUsername && (
                  ...
                  {isConnected && myScore !== null && (
                    <div style={{ marginTop: 'auto', textAlign: 'center', flexShrink: 0, paddingTop: '6px' }}>
                      <motion.button
                        onClick={handleShare}
                        disabled={isSharing}
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                  {username && (
                    <div style={{
                      ...
                      {displayName && (
                        <div style={{ fontSize: '18px', fontWeight: '600', color: '#fff', marginBottom: '6px', lineHeight: '1.4' }}>
                          {displayName}
                        </div>
                      )}
                      {username && (
                        ...
                        <div style={{
                          ...
                          {followerCount !== null && (
                            <div>
                              ...
                              <div style={{ fontSize: '10px', opacity: 0.8, color: 'rgba(255, 255, 255, 0.9)', lineHeight: '1.4' }}>
                                Followers
                              </div>
                            </div>
                          )}
                  ...
                  {followers.length > 0 && (
                    <div style={{
                      ...
                      <h4 style={{ marginTop: 0, marginBottom: '10px', fontSize: '12px', fontWeight: '600', flexShrink: 0, lineHeight: '1.4' }}>
          ...
          {activeTab === 'improve' && (
            ...
            >
              ...
              <div style={{ fontSize: '16px', fontWeight: '600', color: '#fff', marginBottom: '6px', lineHeight: '1.3' }}>
                Improve Score
              </div>
              <div style={{
                fontSize: '12px',
              ...
              <div style={{ marginBottom: '10px', textAlign: 'left', flexShrink: 0 }}>
                ...
                {tipType === 'custom' && (
                  <div style={{ display: 'flex', gap: '5px', alignItems: 'center', marginTop: '5px' }}>
                    ...
                    />
                    <div style={{ fontSize: '11px', color: 'rgba(255, 255, 255, 0.8)', fontWeight: '600', lineHeight: '1.4' }}>
                      {USDC_TOKEN.symbol}
                    </div>
                  </div>
                )}
